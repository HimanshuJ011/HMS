export default class Scale extends Element<import("assets/extensions/chart.js/types/basic.js").AnyObject, import("assets/extensions/chart.js/types/basic.js").AnyObject> {
    constructor(cfg: any);
    /** @type {string} */
    id: string;
    /** @type {string} */
     ...
     */
    getLabelItems(chartArea?: import("assets/extensions/chart.js/types.js").ChartArea): import('assets/extensions/chart.js/types.js').LabelItem[];
    beforeLayout(): void;
    beforeUpdate(): void;
    /**
...
export type Chart = import('assets/extensions/chart.js/types/index.js').Chart;
export type Tick = {
    value: number | string;
    label?: string;
    major?: boolean;
