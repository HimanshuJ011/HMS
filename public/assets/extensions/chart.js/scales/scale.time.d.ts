...
export type Unit = import('assets/extensions/chart.js/core/core.adapters.js').TimeUnit;
export type Interval = {
    common: boolean;
    size: number;
    steps?: number;
};
export type DateAdapter = import('assets/extensions/chart.js/core/core.adapters.js').DateAdapter;
